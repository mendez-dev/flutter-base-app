...
class SimpleRefreshPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SimpleRefreshSmartRefreshWidget(),
    );
  }
}

class SimpleRefreshSmartRefreshWidget extends StatefulWidget {
  @override
  _SimpleRefreshSmartRefreshWidgetState createState() =>
      _SimpleRefreshSmartRefreshWidgetState();
}

class _SimpleRefreshSmartRefreshWidgetState
    extends State<SimpleRefreshSmartRefreshWidget> {
